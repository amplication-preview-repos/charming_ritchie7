...
@InputType()
class PaymentDetailsCreateNestedManyWithoutOrdersInput {
...
export { PaymentDetailsCreateNestedManyWithoutOrdersInput as PaymentDetailsCreateNestedManyWithoutOrdersInput };
